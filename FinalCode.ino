...
void forward() {                                    //group of simple functions that just manipulate the motors in varying ways, to have movement,
  digitalWrite(motor1, LOW);                       //stopping, and rotation 
...
void turnleft() {
  digitalWrite(motor1, LOW);                         //right back
  digitalWrite(motor2, HIGH);                        //right fr
  digitalWrite(motor3, HIGH);                        //left back
  digitalWrite(motor4, LOW);                         //left fr
}
